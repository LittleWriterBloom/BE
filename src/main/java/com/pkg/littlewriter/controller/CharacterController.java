...
//    }
    ...
    @PostMapping("/ai")
    public ResponseEntity<?> convert(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestBody AiCharacterImageRequestDTO characterCreationRequestDTO) throws IOException, InterruptedException {
