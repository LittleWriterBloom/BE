...
@Component
public class EnrichContextAndQuestionGenerator implements OpenAi<RefineContextAndQuestionDTO, BookBuildJsonable> {
    @Autowired
            ...
            """
                      you're a helpful assistant who helps writing a fairy tale
                        ...
                        first, enrich sentences more naturally in fairy tale storybook style, using ~해요 체
                          ...
                          do not contain content of "previousContext"
    ...
    public RefineContextAndQuestionDTO getResponse(BookBuildJsonable jsonable) throws OpenAiException {
        ...
        ChatMessage response = openAiService.createChatCompletion(request)
            ...
            RefineContextAndQuestionResponse refineContextAndQuestionResponse = defaultMapper.readValue(response.getContent(), RefineContextAndQuestionResponse.class);
            return RefineContextAndQuestionDTO.builder()
                    .originResponse(response.getContent())
                    .response(refineContextAndQuestionResponse).build();
