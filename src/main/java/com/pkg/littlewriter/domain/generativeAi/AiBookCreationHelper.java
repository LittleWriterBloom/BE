...
import com.pkg.littlewriter.domain.generativeAi.openAi.chat.dictionary.ContextDictionaryInputJsonable;
        ...
        try {
            ...
            return dalleImageResponse.thenCombine(refineContextAndQuestionDTOCompletableFuture, (dalleResult, contextResult) ->
                    BookInsightDTO.builder()
                            ...
                            .temporaryGeneratedImageUrl(dalleResult.getMessage())
                            .build())
                    .get();
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
        ...
        try {
            ...
            return enrichContextAndQuestionDTOCompletableFuture.thenCombine(imageResponseCompletableFuture, (contextResult, imageResult) ->
                    BookInsightDTO.builder()
                            .generatedQuestions(contextResult.getResponse().getQuestions())
                            .refinedContext(contextResult.getResponse().getRefinedText())
                            .temporaryGeneratedImageUrl(imageResult.getImageUrl())
                            .build())
                    .get();
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
